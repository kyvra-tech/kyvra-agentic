...
AVAILABLE_MODULES = ["tech", "crypto", "vietnam", "indie", "parody", "sport", "political", "war", "humor", "energy", "markets", "web3", "wisdom"]
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    text = (
        ...
        "   tech \\| crypto \\| vietnam \\| indie \\| parody \\| sport \\| political \\| war \\| humor \\| energy \\| markets \\| web3 \\| wisdom\n"
